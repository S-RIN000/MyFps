...
namespace MyFps
{
    ...
    public class CinemachineShake : Singleton<CinemachineShake>
    {
        ...
        */
        ...
        //카메라 흔들기
        public void ShakeCamera(float amplitude = 0.5f, float frequency = 0.5f, float shakeTimer = 0.5f)
        {
            if (isShake)
                return;
        ...
        IEnumerator StartShake(float amplitude = 0.5f, float frequency = 0.5f, float shakeTimer = 0.5f)
        {
            isShake = true;
